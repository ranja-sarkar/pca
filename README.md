...
**Chapter 3** of my book ["A handbook of mathematical models with python"](https://ranja-sarkar.github.io/) is about the linear-algebraic method, principal component analysis ([PCA](https://gist.github.com/ranja-sarkar/3349477dcd8f2f46b4abc5b5c6a09496)). 
...
<img width="406" height="276" alt="pca" src="https://github.com/user-attachments/assets/44a6e523-f582-405b-bfbd-ec4e810e180a" />
...
[PCA and FA](https://www.theanalysisfactor.com/the-fundamental-difference-between-principal-component-analysis-and-factor-analysis/) are similar in what they do, yet different in how they do it. PCA works directly with observed variables, [FA](https://www.egyankosh.ac.in/bitstream/123456789/101439/1/Unit-13.pdf) assumes that they are influenced by few hidden factors and typically employs techniques like max. likelihood estimation (MLE).
