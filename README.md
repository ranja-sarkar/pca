...
Principal Component Analysis (PCA) is based on the **decomposition of a covariance matrix**. The decomposition yields [eigenvectors and eigenvalues](https://setosa.io/ev/eigenvectors-and-eigenvalues/).
